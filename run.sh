...
python main.py -l ES -dp data/hateval2019/hateval2019_es_train.csv -mode tEncoder -tmode offline -bs 20 -epoches 12
# python main.py -l EN -dp data/hateval2019/hateval2019_en_train.csv -mode tEncoder -tmode offline -bs 64 -epoches 12

# Encode from Transformers
python main.py -l ES -dp data/pan21-author-profiling-training-2021-03-14 -wp logs -mode encode -tmode offline -bs 200 -phase train
...
# python main.py -l EN  -mode tImpostor -dp data/pan21-author-profiling-training-2021-03-14 -rp 0.4 -metric cosine -ecnImp siamese -dt data/pan21-author-profiling-training-2021-03-14 -output logs
# python main.py -l ES  -mode tImpostor -dp data/pan21-author-profiling-training-2021-03-14 -rp 0.45 -metric cosine -ecnImp siamese -dt data/pan21-author-profiling-training-2021-03-14 -output logs
