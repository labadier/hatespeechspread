...
# Metric Learning
# python main.py -l ES  -mode metriclearn -bs 64 -epoches 120 -loss contrastive -lr 1e-3 -decay 0 -wp BSM_split_ES.pt -dp data/pan21-author-profiling-training-2021-03-14
